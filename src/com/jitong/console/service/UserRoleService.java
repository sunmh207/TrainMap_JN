...
public class UserRoleService extends BaseService {
	 ...
	 * @throws JTException
	 */
	private List<Role> querySuperRole(String userID) throws JTException {
		...
		if (rolelist != null && rolelist.size() > 0) {
			...
			for (Role role : rolelist) {
				...
				superRoleList.addAll(querySuperRole(role.getCreatorId()));
			}
		}
	...
	public List<Role> queryRoleAndSuperRoleByUserId(String userID) throws JTException {
		List<Role> list = querySuperRole(userID);
	 ...
	 * @throws JTException
	 */
	public void deleteRoleUser(String id, String roleId) throws JTException {
		Transaction tx = null;
		try {
			tx = this.beginTransaction();
			dao.deleteRoleUser(id, roleId);
