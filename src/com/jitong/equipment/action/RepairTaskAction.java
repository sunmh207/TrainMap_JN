...
import com.jitong.equipment.domain.RepairTask;
...
public class RepairTaskAction extends JITActionBase implements Preparable {
	...
	public void prepare() throws JTException {
		...
		if (task != null && !StringUtil.isEmpty(task.getTaskId())) {
			task = (RepairTask) service.findBoById(RepairTask.class, task.getTaskId());
			try {
	...
	public String delete() throws Exception {
		if (task != null && !StringUtil.isEmpty(task.getTaskId())) {
			service.deleteBo(RepairTask.class, task.getTaskId());
	...
	public String getListHQL(ArrayList<Object> params) throws JTException {
		...
		return "from RepairTask t where t.operatorId ='" + loginUser.getId() + "' and t.businessType='" + this.getBusinessType()
				+ "'  order by t.startTime desc";
	}

	public String getCategoryId() {
		return "equipment.repairtask";
	}

	public RepairTask getTask() {
		return task;
	}

	public void setTask(RepairTask task) {
		this.task = task;
	}
