				...
				for (Object o : list) {
					...
					for (Method method : validMethods) {
						...
						case RoleID:
							...
							break;
						case SMSStatus:
							if (JitongConstants.SMS_STATUS_INIT.equals(value)) {
								value = "待发送";
							} else if (JitongConstants.SMS_STATUS_SUCCESS.equals(value)) {
								value = "发送成功";
							} else if (JitongConstants.SMS_STATUS_FAILED.equals(value)) {
								value = "发送失败";
							}
							break;
						case StringBool:
