...
<div align="center" >
<div id="map" style="width:3350px;height:1030px;background-color:blue;"></div>
</div>
...
function AmoyMapType() {
	...
	this.getSrc = function(level, row, column) {
		return "${root}/images/zoom_"+level+"/"+level+"-"+row+"-"+column+".jpeg"; 
	}
}
...
mapbuilder.outputMap(new Point(0, -1), 3);
// 滑块工具
