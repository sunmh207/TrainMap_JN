...
<div id='Pagination' style='float:right;right:0px;width:520px;'>记录总数:<strong>${pager.totalRecords}</strong>&nbsp;
	...
	<input type='text' id='_PageID' value='${pager.currentPage}' name="currentPage"
		style='text-align:center;width:30px;height:13px;font-size:12px;'>
