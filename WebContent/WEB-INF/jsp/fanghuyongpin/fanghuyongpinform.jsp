...
<table width="100%" class="table" cellpadding="0" cellspacing="0" align="center">
	<tr>
 	...
 	<tr>
        ...
        <td class="td_edit">		
			<s:select  name="fanghuyongpin.ch" list="locoList" multiple="true" size="8"/> 
 	...
 	<tr>
        ...
        <td class="td_edit">		
			<s:textfield cssClass="date" name="fanghuyongpin.changeTime" value="%{fanghuyongpin.changeTime}"/> 不填则自动计算
